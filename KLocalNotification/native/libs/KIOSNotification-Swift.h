...
#ifndef KIOSNOTIFICATION_SWIFT_H
#define KIOSNOTIFICATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KIOSNotification",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSDate;
SWIFT_CLASS("_TtC16KIOSNotification16KIOSNotification")
@interface KIOSNotification : NSObject
+ (void)initNotificationWithDelegate:(id <UNUserNotificationCenterDelegate> _Nonnull)delegate SWIFT_METHOD_FAMILY(none);
+ (void)showNotificationWithId:(NSString * _Nonnull)id title:(NSString * _Nonnull)title body:(NSString * _Nonnull)body schedule:(BOOL)schedule date:(NSDate * _Nullable)date data:(NSDictionary * _Nullable)data;
+ (void)removeNotificationWithNotificationId:(NSString * _Nonnull)notificationId;
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("KIOSNotification", usrValue)
...
namespace KIOSNotification SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("KIOSNotification") {


} // namespace KIOSNotification
